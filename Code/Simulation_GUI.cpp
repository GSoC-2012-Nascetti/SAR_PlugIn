...
Simulation_GUI::Simulation_GUI( QWidget* pParent, const char* pName, bool modal,int sensor_type)
: QDialog(pParent)
{
   ...
   box4 = new QGroupBox(tr("Select Input DSM"));
...
Simulation_GUI::~Simulation_GUI(void)
{
}

void Simulation_GUI::init()
{
...
void Simulation_GUI::CheckButton(QAbstractButton* pButton)
{
...
void Simulation_GUI::CheckImage()
{
...
void Simulation_GUI::ComputeGrid()
{
...
bool Simulation_GUI::RetrieveDSMGrid()
{
